 ...
 */
package com.ucams.modules.act.web;
...
public class ActTaskController extends BaseController {
	...
	public String form(Act act, HttpServletRequest request, Model model){
		...
		// 获取流程实例对象
		if("finish".equals(act.getStatus())){
			String[] ss = actTaskService.getHisInstance(act.getProcInsId()).getBusinessKey().split(":");
...
//		return "modules/act/actTaskForm";
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.ucams.modules.act.utils.PropertyType
	 */
