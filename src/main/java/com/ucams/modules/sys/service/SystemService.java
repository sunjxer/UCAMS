...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Role> findRoleByType(Role role,boolean isAll){
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public Integer getAmsUnitDetailinfByoUnitCreditCode(String codeName) {
		AmsUnitDetailinfo r = new AmsUnitDetailinfo();
		r.setUnitCreditCode(codeName);
		return amsUnitDetailinfoDao.getAmsUnitDetailinfByoUnitCreditCode(r);
	}
