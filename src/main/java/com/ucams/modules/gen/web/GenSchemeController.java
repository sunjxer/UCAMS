 ...
 */
package com.ucams.modules.gen.web;
...
import com.ucams.modules.gen.service.GenSchemeService;
import com.ucams.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.ucams.modules");
		}
