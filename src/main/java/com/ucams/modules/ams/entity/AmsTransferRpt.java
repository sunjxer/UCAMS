 ...
 * @version 2017-08-08
 */
public class AmsTransferRpt extends DataEntity<AmsTransferRpt> {
	
	private static final long serialVersionUID = 1L;
	private String transferId;		// 移交id
	...
	public AmsTransferRpt() {
		super();
	}

	public AmsTransferRpt(String id){
		super(id);
	}

	@Length(min=0, max=64, message="移交id长度必须介于 0 和 64 之间")
	...
	@Length(min=0, max=1, message="0-内容 不全（必填项未填），1-文件数量不符长度必须介于 0 和 1 之间")
