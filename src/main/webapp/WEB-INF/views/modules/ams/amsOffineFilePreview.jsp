...
<body>
	<div class="swiper-container">
													...
													<div class="file-preview-frame" id="preview-1502084065708-0" data-fileindex="0" 
														...
														<div class="file-thumbnail-footer">
															<div class="file-footer-caption"
																...
																<samp>(${fileInfo.startPage}-${fileInfo.endPage}页)</samp>
															</div>
		...
		<form:form id="searchForm" action="${ctx}/ams/amsInterface/toPreviewFile" method="post">
				...
				$(this).click(function(){ 
					...
					if(isOverdue != 1){
						...
						if(fileType == 2){  //图片
							...
							html+="src='"+fileUrl+"'";
							html+="title='' style='width: auto; height: auto; max-width: 80%; max-height: 100%;'>";
