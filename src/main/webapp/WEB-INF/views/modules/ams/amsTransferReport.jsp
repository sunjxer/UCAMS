...
<body>
	...
	<form:form id="searchForm" modelAttribute="amsTransfer" action="${ctx}/ams/amsTransfer/export" method="post" class="breadcrumb form-search ">
				<form:hidden path="id"/>
	</form:form>
	<form:form id="inputForm" modelAttribute="amsTransfer" action="${ctx}/ams/amsTransfer/saveRpt" method="post" class="form-horizontal">
	...
	<script type="text/template" id="amsPreRptTpl">//<!--
						<tr id="amsPreRptList{{idx}}">
							...
							<td  width="15%"> 
								<select id="amsPreRptList{{idx}}_errorType" name="amsPreRptList[{{idx}}].errorType" class="required input-mini" style="width:120px;*width:75px" data-value="{{row.errorType}}">
							...
							<td>
								<input id="amsPreRptList{{idx}}_error" name="amsPreRptList[{{idx}}].error" type="text" value="{{row.error}}" style="width:500px;" maxlength="500" class="input-small required"/>
							</td> 
