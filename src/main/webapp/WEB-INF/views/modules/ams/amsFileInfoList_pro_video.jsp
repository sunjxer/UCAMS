...
<body>
	<ul class="nav nav-tabs">
		 <li ><a href="${ctx}/ams/amsFileInfo/amsProjectInfoVideoList?id=${amsFileInfo.projectId}">项目信息</a></li>
	
		<li class="active">
		<%-- <a href="${ctx}/ams/amsFileInfo/amsproInfoList?id=${projectId}">文件列表</a> --%>
		<a href="${ctx}/ams/amsFileInfo/proVideoList?projectId=${amsFileInfo.projectId}&recordId=${amsFileInfo.recordId}">声像档案列表</a>
		</li>
		<shiro:hasPermission name="ams:amsFileInfo:edit"><li><a href="${ctx}/ams/amsFileInfo/form?projectId=${amsFileInfo.projectId}&recordId=${amsFileInfo.recordId}&exten1=-1">声像档案添加</a></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="amsFileInfo" action="${ctx}/ams/amsFileInfo/proVideoList?projectId=${amsFileInfo.projectId}&recordId=${amsFileInfo.recordId}" method="post" class="breadcrumb form-search">
