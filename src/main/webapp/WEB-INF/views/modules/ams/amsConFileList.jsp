...
function closeWin(t){
	...
	location.href = "${ctx}/ams/amsArchivesInfo/conList?id="+id+"&projectId="+projectId;
}
</script>
...
<body>
	<div class="accordion" id="accordion2">
		...
		<input type="hidden" id="amsId" value="${amsConstructDes.id}"/>
		<input type="hidden" id="projectId" value="${amsConstructDes.projectId}"/>
		 	<li><a href="${ctx}/ams/amsArchivesInfo/amsConstructDesList?id=${amsConstructDes.id}">建设工程规划</a></li>
			<shiro:hasPermission name="ams:amsArchivesInfo:edit">
			<li class="active"><a href="${ctx}/ams/amsArchivesInfo/conList?id=${amsConstructDes.id}&projectId=${amsConstructDes.projectId}">文件列表</a></li>
			</shiro:hasPermission>
		</ul>
		...
		<div class="accordion-group">
			...
			<div id="collapseOne" class="accordion-body collapse in ">
				...
				<form:form id="searchForm1" modelAttribute="amsArchivesInfo" action="${ctx}/ams/amsArchivesInfo/conList?id=${amsConstructDes.id}&projectId=${amsConstructDes.projectId}&type=in" method="post" class="breadcrumb form-search">
					...
					<ul class="ul-form">
						...
						<c:if test="${amsConstructDes.amsAcceptance.status == 0 }">
				...
				<form:form id="saveSortForm" modelAttribute="amsArchivesInfo" action="${ctx}/ams/amsArchivesInfo/saveSort?id=${amsConstructDes.id}&projectId=${amsConstructDes.projectId}&type=con" method="post" class="breadcrumb form-search">
		...
		<%-- <div class="accordion-group">
			...
			<div id="collapseTwo" class="accordion-body collapse in ">
				<div class="accordion-inner">
				<form:form id="searchForm2" modelAttribute="amsArchivesInfo" action="${ctx}/ams/amsArchivesInfo/conList?id=${amsConstructDes.id}&projectId=${amsConstructDes.projectId}" method="post" class="breadcrumb form-search">
						...
						<tbody>
							<c:forEach items="${pageAll.list}" var="amsFileInfo">
								<tr>
									...
									<shiro:hasPermission name="ams:amsFileInfo:edit">
									<td>
									<a href="${ctx}/ams/amsArchivesInfo/addFile?fileId=${amsFileInfo.id}&archId=${amsConstructDes.id}&type=con">添加到案卷</a>
									</td>
									</shiro:hasPermission>
								</tr>
							</c:forEach>
	    ...
	    <div class="modal-content" >
	      ...
	      <div id="content" class="row-fluid">
				...
				<div id="right" style="height: auto">
					<iframe id="resBodyContent"  style="width: 650px; height: 400px !important;" frameborder="0"  src="${ctx}/ams/amsArchivesInfo/amsAllFileList?treeId=null&id=${amsConstructDes.id}&type=con"></iframe>
				</div>
			</div>
	...
	var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
		...
		function refreshTree(){
			$.getJSON("${ctx}/ams/amsArchivesInfo/recordTreeData?id=${amsConstructDes.id}&projectId=${amsConstructDes.projectId}&type=con",function(data){
